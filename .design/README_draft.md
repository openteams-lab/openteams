...
| 渠道 | 链接 |
|------|------|
| 🐛 **Bug 反馈** | [GitHub Issues](https://github.com/BloopAI/agents-chatgroup/issues) |
| 💬 **功能讨论** | [GitHub Discussions](https://github.com/BloopAI/agents-chatgroup/discussions) |
| 💭 **社区群** | *即将开放，敬请期待* |
...
> 💡 在提交 PR 之前，建议先通过 [Issue](https://github.com/BloopAI/agents-chatgroup/issues) 或 [Discussion](https://github.com/BloopAI/agents-chatgroup/discussions) 与我们讨论你的想法。
