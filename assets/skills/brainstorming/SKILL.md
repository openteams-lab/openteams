...
6. **Write design doc** — save to `.openteams/specs/YYYY-MM-DD-<topic>-design.html`. write the solution as an HTML file and keep it visually appealing for browsing.
...
- Write the validated design (spec) to `.openteams/specs/YYYY-MM-DD-<topic>-design.html`
  - (User preferences for spec location override this default)
  - write the solution as an HTML file and keep it visually appealing for browsing.
