...
When you add a repository to a workspace, agent-chatgroup creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.agent-chatgroup-workspaces` directory (configurable in Settings).
</Accordion>
