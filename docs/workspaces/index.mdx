...
<Note>
Workspaces is currently in <Badge color="orange">Beta</Badge>. You can enable it in **Settings 鈫?Beta Features 鈫?Enable Workspaces Beta**.
</Note>
...
<Step title="Open Settings">
  Click the 鈿欙笍 icon in the sidebar or navigate to **Settings** from the menu.
</Step>
...
- **From settings**: Disable **Enable Workspaces Beta** in Settings 鈫?Beta Features
...
When you create a workspace, agent-chatgroup:
