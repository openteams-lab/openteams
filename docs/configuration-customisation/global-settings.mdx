...
<Note>
A redesigned Settings experience is available in <Badge color="orange">Beta</Badge>. Access it from the Workspaces UI via the navbar or command bar. [Learn more 鈫抅(/settings-beta)
</Note>

You can configure application-wide settings via the **Settings** page. To access it, click the 鈿欙笍 icon in the sidebar or select "Settings" from the top-right menu.

<Frame>
<img src="/images/vk-settings.png" alt="agent-chatgroup global settings page showing theme options, agent configuration, and settings" />
</Frame>
...
<Frame>
<img src="/images/vk-editor-ssh.png" alt="agent-chatgroup settings editor section showing ssh configuration options." />
</Frame>
...
Define and customise agent variants under **Settings 鈫?Agents**. Variants let you maintain multiple configurations for the same agent (for example, a Claude Code "PLAN" variant).
