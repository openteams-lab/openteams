...
<Info>
Agent profiles are used throughout agent-chatgroup wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>

## Configuration Access

You can configure agent profiles in two ways through Settings 鈫?Agents:
...
<Note>
The configuration page displays the exact file path where your settings are stored. agent-chatgroup saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Tab title="CLAUDE_CODE">
  ...
  [View full CLI reference 鈫抅(https://docs.anthropic.com/en/docs/claude-code/cli-reference#cli-flags)
</Tab>
...
<Tab title="GEMINI">
  ...
  [View full CLI reference 鈫抅(https://google-gemini.github.io/gemini-cli/)
</Tab>
...
<Tab title="AMP">
  ...
  [View full documentation 鈫抅(https://ampcode.com/manual#cli)
</Tab>
...
<Tab title="CODEX">
  ...
  [View full documentation 鈫抅(https://github.com/openai/codex)
</Tab>
...
<Tab title="CURSOR">
  ...
  [View full CLI reference 鈫抅(https://docs.cursor.com/en/cli/reference/parameters)
</Tab>
...
<Tab title="OPENCODE">
  ...
  [View full documentation 鈫抅(https://opencode.ai/docs/cli/#flags-1)
</Tab>
...
<Tab title="QWEN_CODE">
  ...
  [View full documentation 鈫抅(https://qwenlm.github.io/qwen-code-docs/en/cli/index)
</Tab>
...
<Tab title="DROID">
  ...
  [View full documentation 鈫抅(https://docs.factory.ai/factory-cli/getting-started/overview)
</Tab>
</Tabs>
...
<Card title="Default Configuration" icon="gear">
  Set your default agent and variant in **Settings 鈫?General 鈫?Default Agent Configuration** for consistent behaviour across all attempts.
</Card>
...
<Note>
MCP (Model Context Protocol) servers are configured separately under **Settings 鈫?MCP Servers** but work alongside agent profiles to extend functionality.
</Note>

<CardGroup cols={2}>
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within agent-chatgroup for your coding agents
</Card>

<Card title="agent-chatgroup MCP Server" icon="plug" href="/integrations/agent-chatgroup-mcp-server">
  Connect external MCP clients to agent-chatgroup's MCP server
</Card>
</CardGroup>
