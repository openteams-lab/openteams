...
| **Project icons** | Square buttons showing project abbreviations (e.g., "VI" for agent-chatgroup) |
...
| **To do** | Issues ready to start | 鉁?|
| **In progress** | Issues currently being worked on | 鉁?|
| **In review** | Waiting for code review | 鉁?|
| **Done** | Completed issues | 鉁?|
...
<Tip>
You can also manage projects from **Settings** 鈫?**Remote Projects**. See [Remote Projects Settings](/settings-beta/remote-projects) for more details.
</Tip>
...
To delete a project, go to **Settings** 鈫?**Remote Projects**:
...
<Step title="Open the menu">
  Hover over the project and click the **鈰?* (three dots) menu.
...
For more details on managing projects, see [Remote Projects Settings](/settings-beta/remote-projects).
...
- [Remote Projects Settings](/settings-beta/remote-projects) - Managing projects from Settings
