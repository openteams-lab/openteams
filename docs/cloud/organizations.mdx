...
Organisations are the top-level container in agent-chatgroup Cloud. They group your team members and projects together.
...
For detailed information about all organisation settings, see the [Organisation Settings](/settings-beta/organization-settings) page.
...
| View projects | 鉁?| 鉁?|
| Create projects | 鉁?| 鉁?|
| Edit project settings | 鉁?| 鉁?|
| Create/edit tasks | 鉁?| 鉁?|
| Invite members | 鉁?| 鉂?|
| Remove members | 鉁?| 鉂?|
| Change member roles | 鉁?| 鉂?|
| Edit organisation settings | 鉁?| 鉂?|
| Delete organisation | 鉁?| 鉂?|
...
- [Getting Started](/cloud/getting-started) - Initial setup of agent-chatgroup Cloud
