---
title: "agent-chatgroup Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

<Note>
agent-chatgroup Cloud is currently in <Badge color="orange">Beta</Badge>. Features may change before stable release.
</Note>

## What is agent-chatgroup Cloud?

**agent-chatgroup Cloud** adds team collaboration to agent-chatgroup. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same agent-chatgroup interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same agent-chatgroup installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run agent-chatgroup** as usual with `npx agent-chatgroup`
...
Think of it as your company or team in agent-chatgroup.
...
- Review code directly in agent-chatgroup
- Track PR status

## Getting Started

<Steps>
<Step title="Run agent-chatgroup">
  ```bash
  npx agent-chatgroup
  ```
</Step>
...
- Some features may change between updates
- Advanced features like notifications are still in development
</Warning>
