...
description: "Solutions for common issues with agent-chatgroup Cloud"
---

This page covers common issues you might encounter with agent-chatgroup Cloud and how to resolve them.
...
4. Return to agent-chatgroup and sign in again
</Accordion>
...
**Solutions:**
1. Go to Organisation Settings 鈫?GitHub Integration
...
3. Try a different browser
4. Restart agent-chatgroup (`npx agent-chatgroup`)
</Accordion>
...
1. **Check existing issues:** [github.com/BloopAI/agent-chatgroup/issues](https://github.com/BloopAI/agent-chatgroup/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/BloopAI/agent-chatgroup/issues/new">
