...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=bloop.agent-chatgroup">
...
3. Search for `@id:bloop.agent-chatgroup`
4. Click **Install**
</Tab>
...
<Card title="Open VSX Registry" icon="download" href="https://open-vsx.org/extension/bloop/agent-chatgroup">
...
**Solutions**:
- Verify the extension is installed by searching `@id:bloop.agent-chatgroup` in Extensions
...
<Info>
The extension is designed to work with any VSCode-compatible editor. If you're using a different VSCode fork, try installing from Open VSX Registry using the extension ID `bloop.agent-chatgroup`.
</Info>
