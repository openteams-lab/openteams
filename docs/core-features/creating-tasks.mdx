...
<Tip>
For detailed setup instructions and examples, see the [openteams MCP Server](/integrations/openteams-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your openteams project based on this description.
