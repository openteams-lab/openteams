...
<Tip>
For detailed setup instructions and examples, see the [agent-chatgroup MCP Server](/integrations/agent-chatgroup-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your agent-chatgroup project based on this description.
