...
<Tip>
For detailed setup instructions and examples, see the [agents-chatgroup MCP Server](/integrations/agents-chatgroup-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your agents-chatgroup project based on this description.
