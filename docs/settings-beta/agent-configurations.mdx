...
<Info>
Agent profiles are used throughout agent-chatgroup wherever agents run: onboarding, default settings, attempt creation, and follow-ups. The default configuration appears pre-selected in the agent dropdown in the chat input.
</Info>
...
Access agent profiles via **Settings 鈫?Agents** in the Workspaces UI.
...
<Card title="Default Configuration" icon="gear">
  Set your default agent and variant in **Settings 鈫?General 鈫?Default Coding Agent** for consistent behaviour across all attempts.
</Card>
