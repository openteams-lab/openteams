...
description: "Common issues and solutions when using openteams"
---
...
If you encounter irrecoverable errors and need to completely wipe your openteams database, you can delete the application data directory for your operating system. 
...
Typically: `C:\Users\<username>\AppData\Roaming\starterra.ai\openteams\`
</Tab>
</Tabs>

After deleting the application data directory, restart openteams to reset with an empty database and default settings.
