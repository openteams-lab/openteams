...
description: "Common issues and solutions when using agents-chatgroup"
---
...
If you encounter irrecoverable errors and need to completely wipe your agents-chatgroup database, you can delete the application data directory for your operating system. 
...
Typically: `C:\Users\<username>\AppData\Roaming\starterra.ai\agents-chatgroup\`
</Tab>
</Tabs>

After deleting the application data directory, restart agents-chatgroup to reset with an empty database and default settings.
