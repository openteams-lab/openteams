...
## Authentication
Authenticate and configure CCR outside of openteams. Follow the instructions on the CCR GitHub repo:
...
openteams does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in openteams

<Frame>
<img src="/images/ccr-agent-config.png" alt="Claude Code agent configuration in openteams" />
</Frame>

## Using CCR in openteams
