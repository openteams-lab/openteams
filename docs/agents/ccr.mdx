...
## Authentication
Authenticate and configure CCR outside of agents-chatgroup. Follow the instructions on the CCR GitHub repo:
...
## Configure agents-chatgroup

agents-chatgroup does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in agents-chatgroup

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in agents-chatgroup" />
</Frame>

## Using CCR in agents-chatgroup
