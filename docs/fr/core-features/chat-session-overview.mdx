...
<Frame caption="Les messages d'une session de chat incluent des messages utilisateur, des messages de membres IA, des messages de tache et des messages systeme.">
  <img src="/images/zh/groupchat_session.png" alt="Vue chronologique des messages dans une session de chat openteams" />
</Frame>
...
![Citer un message](../../images/zh/cite_message.png)
...
![Gerer les sessions de chat](../../images/zh/manage_session.png)
...
<Tab title="Mode Travail">
  <Note>Pris en charge a partir de la version v0.3.12</Note>
