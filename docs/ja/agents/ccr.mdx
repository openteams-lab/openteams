...
openteamsにはCCRのデフォルト設定は付属していません。既存のClaude Codeエージェントに設定を追加：
...
### 例：openteamsでのClaude Codeエージェント設定

<Frame>
<img src="/images/ccr-agent-config.png" alt="openteamsでのClaude Codeエージェント設定" />
</Frame>
