...
icon: https://www.agent-chatgroup.com/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in agent-chatgroup, you must first authenticate:
...
Droid supports several configuration options in agent-chatgroup:
...
These options can be configured when creating agent configurations in agent-chatgroup.
