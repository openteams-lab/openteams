...
icon: https://www.agent-chatgroup.com/images/logos/claude.svg#"
---
...
## Installation
CCR is available via `npx` 鈥?no separate installation required.
...
## Authentication
Authenticate and configure CCR outside of agent-chatgroup. Follow the instructions on the CCR GitHub repo:
...
## Configure agent-chatgroup

agent-chatgroup does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in agent-chatgroup

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in agent-chatgroup" />
</Frame>

## Using CCR in agent-chatgroup
