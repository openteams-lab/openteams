...
assert.ok(palette.includes('groupCommandsByCategory(commands)'));
assert.ok(palette.includes('data-command-category={group.categoryKey}'));
assert.ok(palette.includes('categoryTitleFor(group.categoryKey)'));
...
assert.ok(help.includes('data-command-category={group.categoryKey}'));
assert.ok(help.includes('categoryTitleFor(group.categoryKey)'));
