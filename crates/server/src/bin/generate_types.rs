...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::chat_message_target::ChatMessageTarget::decl(),
        db::models::chat_message_target::ChatMessageTargetRouteKind::decl(),
        db::models::chat_message_target::ChatMessageTargetResolutionStatus::decl(),
        ...
        db::models::inbox_item::InboxItemSeverity::decl(),
        services::services::inbox::InboxSummary::decl(),
        services::services::inbox::InboxSummaryCount::decl(),
        services::services::inbox::MarkInboxItemsReadRequest::decl(),
        services::services::inbox::MarkAllInboxItemsReadRequest::decl(),
        services::services::inbox::InboxItemsMarkedReadResponse::decl(),
        services::services::inbox::InboxItemsArchivedResponse::decl(),
        server::routes::inbox::InboxSummaryQuery::decl(),
        server::routes::inbox::InboxItemsQuery::decl(),
        server::routes::inbox::InboxItemsResponse::decl(),
        server::routes::inbox::InboxItemResponse::decl(),
        ...
        server::routes::chat::sessions::WorkspaceGitErrorCode::decl(),
        server::routes::chat::sessions::WorkspaceGitErrorData::decl(),
        server::routes::chat::sessions::GitignoreTemplateSummary::decl(),
        server::routes::chat::sessions::GitignoreTemplatesResponse::decl(),
        ...
        server::routes::version::UpdatePlatform::decl(),
        server::routes::version::UpdateArchitecture::decl(),
        server::routes::version::UpdateMethod::decl(),
        server::routes::version::UpdateCheckStatus::decl(),
        server::routes::version::UpdateDownloadStatus::decl(),
        server::routes::version::UpdateInstallStatus::decl(),
        server::routes::version::UpdateErrorStage::decl(),
        server::routes::version::UpdateErrorInfo::decl(),
        server::routes::version::UpdateCapability::decl(),
        server::routes::version::UpdateCheckQuery::decl(),
        server::routes::version::DesktopUpdateContext::decl(),
        server::routes::version::VersionCheckResponse::decl(),
        server::routes::version::UpdateOperationState::decl(),
        server::routes::version::UpdateActionResponse::decl(),
        ...
        server::routes::chat::search::ChatSearchMode::decl(),
        server::routes::chat::search::ChatSearchQuery::decl(),
        server::routes::chat::search::ChatSearchResult::decl(),
        server::routes::chat::search::ChatSearchResponse::decl(),
        ...
        server::routes::chat::runtime::ChatActiveRunStatus::decl(),
        server::routes::chat::runtime::ChatActiveRun::decl(),
        server::routes::chat::runtime::ChatSessionRuntimeSnapshot::decl(),
        server::routes::chat::runtime::ChatSessionRuntimeQuery::decl(),
        ...
        server::routes::chat::messages::CreateChatMessageResponse::decl(),
        ...
        services::services::config::KeyboardShortcutsConfig::decl(),
        services::services::config::KeyboardShortcutBinding::decl(),
        services::services::config::KeyboardShortcutOverride::decl(),
        ...
        services::services::config::ChatTeamTemplateTier::decl(),
        ...
        server::routes::chat::presets::TeamPresetLocaleQuery::decl(),
