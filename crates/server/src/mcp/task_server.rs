...
impl ServerHandler for TaskServer {
    fn get_info(&self) -> ServerInfo {
        ...
        if self.context.is_some() {
            let context_instruction = "Use 'get_context' to fetch project/task/workspace metadata for the active agent-chatgroup workspace session when available.";
        ...
        ServerInfo {
            ...
            server_info: Implementation {
                name: "agent-chatgroup".to_string(),
