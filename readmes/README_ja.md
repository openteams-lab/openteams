...
<div align="center">
  <video src="./images/Hero2.webm" controls width="100%">
    <a href="./images/Hero2.webm">製品動画を見る</a>
  </video>
</div>

## ところで、openteams とは？

すでに Claude Code、Codex、Gemini CLI などのコーディングエージェントを使っているでしょう。どれも単独なら問題なく働きます。そこで二つ目のターミナルを開き、さらに三つ目を開きます。同じコンテキストを繰り返し伝え、結果を別のウィンドウへ運び、誰が何を変更しているかを自分で覚えておきます。数日後には、コードは複数のセッションに散らばり、タスク一覧は別の場所にあり、使ったトークンで何が作られたのかを簡単に説明できなくなります。
