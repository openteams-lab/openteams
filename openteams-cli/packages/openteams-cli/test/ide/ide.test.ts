...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENTEAMS_CALLER", () => {
    process.env["OPENTEAMS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENTEAMS_CALLER", () => {
    process.env["OPENTEAMS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENTEAMS_CALLER", () => {
    process.env["OPENTEAMS_CALLER"] = "unknown"
