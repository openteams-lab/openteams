...
const TIPS = [
  ...
  "Create {highlight}openteams.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/openteams-cli/tui.json{/highlight} for global config",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.openteams/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.openteams/agent/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.openteams/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.openteams/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent OpenCode from reading sensitive files",
  "Use {highlight}openteams-cli run{/highlight} for non-interactive scripting",
  "Use {highlight}openteams-cli --continue{/highlight} to resume the last session",
  "Use {highlight}openteams-cli run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}openteams-cli serve{/highlight} for headless API access to OpenCode",
  "Use {highlight}openteams-cli run --attach{/highlight} to connect to a running server",
  "Run {highlight}openteams-cli upgrade{/highlight} to update to the latest version",
  "Run {highlight}openteams-cli auth list{/highlight} to see all configured providers",
  "Run {highlight}openteams-cli agent create{/highlight} for guided agent creation",
  "Use {highlight}/openteams-cli{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}openteams-cli github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/openteams-cli fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.openteams/themes/{/highlight} directory",
  ...
  "Run {highlight}openteams-cli debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/openteams-cli{/highlight} for containerized use",
